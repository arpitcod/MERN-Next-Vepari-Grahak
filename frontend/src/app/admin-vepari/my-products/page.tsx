...
const MyProductsPage = () => {
  ...
  }, [vepari]); // vepari._id change thay tyare fetch
          ...
          {products?.map((product:ProductsType) => (
            ...
            >
              ...
              <div className="grid grid-cols-2 gap-2 justify-between">
                <button
                  onClick={() => product._id && handleShowEditProductBox(product?._id)}
                ...
                <button className="flex items-center justify-center gap-0.5 border py-2 bg-red-500 text-indigo-50 hover:bg-red-600 transition-all rounded-md">
